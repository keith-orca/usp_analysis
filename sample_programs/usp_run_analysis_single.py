...
usp = lmd.load_npy_file('C:\\Users\\15163\\Desktop\\stanford_software\\usp_analysis_code\\usp_data\\np63_cw100ms_30s_interval_intensities_2.npy')
#sp2 = lmd.load_npy_file('C:\\Users\\15163\\Desktop\\stanford_software\\usp_analysis_code\\usp_data\\bns1_dcdur_20hz_1.npy')
#usp.acquire_usp_data(usp2)
#usp.write_file('cmtb14_20hz40s_intensity_new')
#usp.remove_events(ch, 1)
usp.remove_decay(ch, padding=True, decay_type='linear') # padding offsets - values by adding back the abs(min) of the whole trace
